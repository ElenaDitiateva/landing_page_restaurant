...
document.addEventListener("DOMContentLoaded", function (domLoadedEvent) {
	...
	new core_class('.menu__slider .slider__wrapper', {
		spaceBetween: 15,
	...
	new core_class('.reviews__slider .slider__wrapper', {
		spaceBetween: 15,
		wrapperClass: 'slider__list',
		slideClass: 'slider__item',
		slidesPerView: 1,
		...
		pagination: {
			el: ".reviews__slider .slider__pagination",
			bulletClass: "slider__bullet",
			bulletActiveClass: "slider__bullet--active",
			clickable: true,
		},
	...
	new core_class('.cooks__slider .slider__wrapper', {
		spaceBetween: 15,
		wrapperClass: 'slider__list',
		slideClass: 'slider__item',
		slidesPerView: 1,
		...
		pagination: {
			el: ".cooks__slider .slider__pagination",
			bulletClass: "slider__bullet",
			bulletActiveClass: "slider__bullet--active",
			clickable: true,
		},
	...
	let statsValues = document.querySelectorAll('.stats__value');
	...
	for (let i = 0; i < statsValues.length; i++) {
		...
		if (statsValues[i].getBoundingClientRect().top >= 0 && statsValues[i].getBoundingClientRect().top - window.innerHeight <= 0) {
			dist_default()(statsValues[i], {
				duration: 1000,
				delay: 16,
			});
